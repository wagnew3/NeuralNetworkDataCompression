...
flags.DEFINE_integer("edim", 300, "internal state dimension [150]")
flags.DEFINE_integer("lindim", 75, "linear part of the state [75]")
flags.DEFINE_integer("nhop", 6, "number of hops [6]")
flags.DEFINE_integer("mem_size", 300, "memory size [100]")
...
def main(_):
    ...
    train_data = read_data('%s/enwiki8.txt' % (FLAGS.data_dir), count, word2idx)
